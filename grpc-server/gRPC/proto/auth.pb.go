...
type AuthData struct {
	...
	CreateData    int64                  `protobuf:"varint,3,opt,name=createData,proto3" json:"createData,omitempty"`
	ExpireData    int64                  `protobuf:"varint,4,opt,name=expireData,proto3" json:"expireData,omitempty"`
...
func (x *AuthData) GetCreateData() int64 {
	if x != nil {
		return x.CreateData
	}
	return 0
...
func (x *AuthData) GetExpireData() int64 {
	if x != nil {
		return x.ExpireData
	}
	return 0
...
const file_gRPC_proto_auth_proto_rawDesc = "" +
	...
	"\n" +
	"createData\x18\x03 \x01(\x03R\n" +
	"createData\x12\x1e\n" +
	"\n" +
	"expireData\x18\x04 \x01(\x03R\n" +
	"expireData\"N\n" +
	"\x06Verify\x12%\n" +
